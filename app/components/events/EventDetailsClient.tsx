...
import { Calendar, Clock, MapPin, ArrowLeft, ArrowRight, User, Globe, Ticket } from "lucide-react";
...
export default function EventDetailsClient({ eventId, initialEvent }: { eventId: number; initialEvent: any }) {
    const { user } = useAuth();
